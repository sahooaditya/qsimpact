...
const Home = () => {
  useEffect(() => {
    ...
    const check = (e: MouseEvent) => {
      ...
      if (!checkParent(target as Node, navMenuDiv)) {
        // Click NOT on the menu
        if (checkParent(target as Node, navMenu)) {
          // Click on the link
        ...
        <nav id="header" className="fixed w-full z-30 top-0 text-white">
          <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
            ...
            >
              ...
              <button
                id="navAction"
                className="mx-auto lg:mx-0 hover:underline bg-[#3b3327] text-black font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
              >
                Action
              </button>
            </div>
          ...
          <div className="container mx-auto px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="flex flex-col items-center">
                ...
                />
                <div className="mt-4">
                  <h3 className="text-lg font-bold text-[#FFAF00]">
                    Jane Smith
                  </h3>
                    ...
                    <div className="transition-all duration-300 cursor-pointer w-full shadow-lg hover:shadow-xl rounded-lg bg-gray-100 relative">
                      ...
                      <div className="p-6 mt-7">
                        ...
                        <div className="mt-2 text-gray-900 text-sm">
                          ...
                          Communities, Organizations, and Students CLT-ECOS
                          equips you with the information and skills needed to
                          make high-impact changes in your social and
                          professional life.
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="transition-all  duration-300 cursor-pointer w-full shadow-lg hover:shadow-xl rounded-lg bg-gray-100 relative">
                      ...
                      <div className="p-6 mt-7">
                        ...
                        <div className="mt-2 text-gray-900 text-sm">
                          ...
                          young people work with our councils to learn, create
                          and implement solutions through a hands-on project in
                          DRC, Niger, Pakistan or Uganda.
                        </div>
                      </div>
                    </div>
                  </a>
